...
#define DEVICE_NAME                         "nRF40Watch"                            /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                   "joaquim.org"                           /**< Manufacturer. Will be passed to Device Information Service. */
...
int main(void)
{
    bool erase_bonds = false; // Set to true if the clear bonding button was pressed to wake the application up.

    // Initialize modules.
    log_init();
    clock_init();

    NRF_LOG_INFO("nRF40Watch Firmware version 1.0.");
    ...
    NRF_LOG_INFO("nRF40Watch started.");
...
void vApplicationStackOverflowHook(TaskHandle_t xTask, char *pcTaskName)
{
    ...
    // Handle stack overflow as desired (e.g., logging, system halt, etc.)
